...
class ZocialScreen extends StatefulWidget {
  @override
  _ZocialScreenState createState() => _ZocialScreenState();
}

class _ZocialScreenState extends State<ZocialScreen> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Icon(
                            Zocial.getIconData('${_Simples[index]}'),
                            size: 29.0,
                          ),
                        ),
                        Padding(

...
class MaterialCommunityScreen extends StatefulWidget {
  @override
  _MaterialCommunityScreenState createState() => _MaterialCommunityScreenState();
}

class _MaterialCommunityScreenState extends State<MaterialCommunityScreen> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Icon(
                            MaterialCommunityIcons.getIconData('${_Simples[index]}'),
                            size: 29.0,
                          ),
                        ),
                        Padding(

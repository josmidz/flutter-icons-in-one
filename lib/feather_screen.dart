...
class FeatherScreen extends StatefulWidget {
  @override
  _FeatherScreenState createState() => _FeatherScreenState();
}

class _FeatherScreenState extends State<FeatherScreen> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Icon(
                            Feather.getIconData('${_Simples[index]}'),
                            size: 29.0,
                          ),
                        ),
                        Padding(

...
class EntyPoScreen extends StatefulWidget {
  @override
  _EntyPoScreenState createState() => _EntyPoScreenState();
}

class _EntyPoScreenState extends State<EntyPoScreen> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Icon(
                            Entypo.getIconData('${_Simples[index]}'),
                            size: 29.0,
                          ),
                        ),
                        Padding(
